...
<body>
    ...
    <div>
        ...
        <!--2장 6절 윈도우 함수-->
        <!--Q) 상영 정보(schedule.sid)를 기준으로 예매/취소/관람 전체 수를 집계한 GROUP BY SQL 문장을 수행하고 그 수가 높은 순으로 출력한다. 이때, 동일한 값이라면 SID를 오름차순하여 출력한다.-->
        <div>
            <h3>2장 6절 윈도우 함수</h3>
            <h4>Q) 상영 정보(schedule.sid)를 기준으로 예매/취소/관람 전체 수를 집계한 GROUP BY SQL 문장을 수행하고 그 수가 높은 순으로 출력한다. 이때, 동일한 값이라면 SID를 오름차순하여 출력한다.</h4>
            <?php
